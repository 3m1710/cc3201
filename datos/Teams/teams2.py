...
franchises = {}
for row in reader3:
	franchises[row["franchID"]] = row["franchName"]

for row in reader:		
	new_row ={}

	if not [row["teamID"], franchises[row["franchID"]], row["name"]] in lista:
		lista.append([row["teamID"], franchises[row["franchID"]], row["name"]])

		new_row["teamID"] = row["teamID"]
		new_row["name"] = 	row["name"]	
		#new_row["franchID"] = row["franchID"]		
		new_row["season_debut"]  = row["yearID"]		
		new_row["franchName"] = franchises[row["franchID"]] 		
