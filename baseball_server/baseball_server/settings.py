"""
Django settings for baseball_server project.
...
SECRET_KEY = '+pl@eiou9*$ns7czr5v6ybq70bh1hy9ao+*@t%*yv6-if5=e2g'
...
ROOT_URLCONF = 'baseball_server.urls'
